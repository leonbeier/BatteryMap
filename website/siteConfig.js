...
const siteConfig = {
  ...
  title: 'Battery Map', // Title for your website.
  tagline: 'Alles was Sie über Akkus und Batterien wissen müssen',
  url: 'https://batterymap.info', // Your website URL
  ...
  headerLinks: [
    { doc: 'overview_accu', label: 'Akkus' },
    { doc: 'overview_battery', label: 'Batterien' },
    { doc: 'overview_future', label: 'Zukunft' },
